...
public class FilesystemImpl extends MinimalEObjectImpl.Container implements Filesystem {
	 ...
	 * @generated
	 */
	public EList getDrives() {
		if (drives == null) {
			drives = new EObjectContainmentEList(Drive.class, this, FilesystemPackage.FILESYSTEM__DRIVES);
		}
		return drives;
	}
	 ...
	 * @generated
	 */
	public EList getSyncs() {
		if (syncs == null) {
			syncs = new EObjectContainmentEList(Sync.class, this, FilesystemPackage.FILESYSTEM__SYNCS);
		}
		return syncs;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FilesystemPackage.FILESYSTEM__DRIVES:
				getDrives().clear();
				getDrives().addAll((Collection)newValue);
				return;
			case FilesystemPackage.FILESYSTEM__SYNCS:
				getSyncs().clear();
				getSyncs().addAll((Collection)newValue);
				return;
		}
